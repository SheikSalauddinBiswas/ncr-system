...
<head>
  ...
  <title>NCRS Admin</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('public/vendor/feather/feather.css')}}">
  <link rel="stylesheet" href="{{asset('public/vendor/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('public/vendor/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{asset('public/vendor/datatables.net-bs4/dataTables.bootstrap4.css')}}">
  <link rel="stylesheet" href="{{asset('public/vendor/ti-icons/css/themify-icons.css')}}">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{ asset('public/images/logo.svg') }}" class="mr-2" alt="logo"/></a>
