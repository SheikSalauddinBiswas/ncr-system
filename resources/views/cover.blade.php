...
<html lang="en">
  ...
  <head>
    ...
    <title>National Crime Reporting System</title>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/templatemo-grad-school.css') }}">
...
<body>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video">
          <source src="{{ asset('public/images/course-video.mp4') }}" type="video/mp4" />
      </video>

      <div class="video-overlay header-text">
          <div class="caption">
              <h6>==== Safety Is Our Priority ====</h6>
              <h2><em>NCR</em> SYSTEM</h2>
              <div class="main-button">
                  <div class="scroll-to-section"><a href="">LogIn / SignUp</a></div>
              </div>
          </div>
      </div>
  </section>
      ...
      <div class="row">
          ...
          <div class="features-post">
            <div class="features-content">
              <div class="content-show">
                <h4><i class="fa fa-female"></i>eve teasing</h4>
              </div>
        ...
        <div class="col-lg-4 col-12">
          <div class="features-post second-features">
            <div class="features-content">
              <div class="content-show">
                <h4><i class="fa fa-user-secret"></i>Cyber Crime</h4>
              </div>
              <div class="content-hide">
                <p>Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet. Donec maximus elementum ex. Cras convallis ex rhoncus, laoreet libero eu, vehicula libero.</p>
                <p class="hidden-sm">Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet.</p>
        ...
        <div class="col-lg-4 col-12">
          <div class="features-post third-features">
            <div class="features-content">
              <div class="content-show">
                <h4><i class="fa fa-shield"></i>robbery</h4>
              </div>
              <div class="content-hide">
                <p>Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet. Donec maximus elementum ex. Cras convallis ex rhoncus, laoreet libero eu, vehicula libero.</p>
                <p class="hidden-sm">Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <a href="#" class="play"><img src="{{ asset('public/images/main-thumb.png') }}"></a>
            </figure>
          </article>
        </div>
      </div>
